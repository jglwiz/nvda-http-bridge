...
Query the live `capabilities` endpoint before assuming limits. Version 1.0.0 defaults are depth 3, 20 children per parent, 200 nodes, and 500 ms. Synchronous hard limits are depth 10, 200 children, 1000 nodes, 3000 ms, and 2 MiB. Exports retain emergency caps of depth 100, 10,000 children, 1,000,000 nodes, 100 MiB per job, 200 MiB total, and 300 seconds.
...
| `504 mainThreadTimeout` | NVDA main thread did not run before deadline | Diagnose rather than increasing limits |
